	...
	<body style="font-family:Arial, Helvetica, sans-serif;"> 
		...
		<div style="margin:0% 15%; align-content:center;">	<!-- s_t_mod Nuovo Stile -->
			...
			<div style = "text-align:left; margin-left:10%; margin-right:10%">
				...
				<h5 style = "margin-bottom:4%;  font-weight:normal;"> <?php echo convert_RS('KNOWLEDGE AREA') . ': '; ?> <i style = "float:right; font-weight:bold;"><?php echo translate_category($_SESSION['course']['ka']);?></i> </h5> <!-- s_t_mod Hui -->
