				...
				<center>
					<div id="risposta">
						...
						<h4 style="margin-bottom:5%;">
							<span><img class="fakeLink" src="themes/img/question.png" style="width:16px;height:16px" title="<?php echo convert_RS('Number of resources description'); ?> "></span>	<!-- s_t_mod Hui -->
							<?php echo convert_RS('Number of resources:'); ?> <b class="ka" id="ka"><?php echo $first_value_pos; ?></b>
						</h4>
