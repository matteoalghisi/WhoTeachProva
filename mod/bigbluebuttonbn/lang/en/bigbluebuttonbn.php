...
$string['activityoverview'] = 'You have upcoming Whoteach Live sessions';
...
$string['bigbluebuttonbn:addinstance'] = 'Add a new Whoteach Live room/activity';
$string['bigbluebuttonbn:join'] = 'Join a Whoteach Live meeting';
$string['bigbluebuttonbn:view'] = 'View a room/activity';
$string['bigbluebuttonbn:managerecordings'] = 'Manage Whoteach Live recordings';
...
$string['bigbluebuttonbn'] = 'Whoteach Live';
$string['indicator:cognitivedepth'] = 'Whoteach Live cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Whoteach Live activity.';
$string['indicator:socialbreadth'] = 'Whoteach Live social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Whoteach Live activity.';
$string['modulename'] = 'Whoteach Live';
$string['modulenameplural'] = 'Whoteach Live';
$string['modulename_help'] = 'Whoteach Live lets you create from within Moodle links to real-time on-line classrooms using Whoteach Live, an open source web conferencing system for distance education.

Using Whoteach Live you can specify for the title, description, calendar entry (which gives a date range for joining the session), groups, and details about the recording of the on-line session.';
$string['modulename_link'] = 'Whoteach Live/view';
$string['pluginadministration'] = 'Whoteach Live administration';
$string['pluginname'] = 'Whoteach Live';
...
$string['search:activity'] = 'Whoteach Live - activity information';
$string['search:tags'] = 'Whoteach Live - tags information';

$string['privacy:metadata:bigbluebuttonbn'] = 'Stores the configuration for the room or activity that defines the features and general behaviour of the Whoteach Live session.';
...
$string['privacy:metadata:bigbluebutton'] = 'In order to create and join Whoteach Live sessions, user data needs to be exchanged with the server.';
$string['privacy:metadata:bigbluebutton:userid'] = 'The userid of the user accessing the Whoteach Live server.';
$string['privacy:metadata:bigbluebutton:fullname'] = 'The fullname of the user accessing the Whoteach Live server.';

$string['config_general'] = 'General configuration';
$string['config_general_description'] = 'These settings are <b>always</b> used';
$string['config_server_url'] = 'Whoteach Live Server URL';
$string['config_server_url_description'] = 'The URL of your Whoteach Live server must end with /Whoteach Live/. (This default URL is for a Whoteach Live server provided by Blindside Networks that you can use for testing.)';
$string['config_shared_secret'] = 'Whoteach Live Shared Secret';
$string['config_shared_secret_description'] = 'The security salt of your Whoteach Live server.  (This default salt is for a Whoteach Live server provided by Blindside Networks that you can use for testing.)';
...
$string['config_recording_default_description'] = 'If enabled the sessions created in Whoteach Live will have recording capabilities.';
...
$string['config_waitformoderator_cache_ttl_description'] = 'To support a heavy load of clients this plugin makes use of a cache. This parameter defines the time the cache will be kept before the next request is sent to the Whoteach Live server.';
...
$string['config_preuploadpresentation_description'] = 'These settings enable or disable options in the UI and also define default values for these options. The feature works only if the Moodle server is accessible to Whoteach Live..';
...
$string['config_extended_capabilities_description'] = 'Configuration for extended capabilities when the Whoteach Live server offers them.';
$string['config_uidelegation_enabled'] = 'UI delegation is enabled';
$string['config_uidelegation_enabled_description'] = 'These settings enable or disable the UI delegation to the Whoteach Live server.';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'Whoteach Live is making use of config.php with a global variable that has been deprecated. Please convert the file as it will not be supported in future versions';
...
$string['general_error_unable_connect'] = 'Unable to connect. Please check the url of the Whoteach Live server AND check to see if the Whoteach Live server is running.';
...
$string['index_error_unable_display'] = 'Unable to display the meetings. Please check the url of the Whoteach Live server AND check to see if the Whoteach Live server is running.';
...
$string['index_heading'] = 'Whoteach Live Rooms';
...
$string['mod_form_field_welcome_help'] = 'Replaces the default message setted up for the Whoteach Live server. The message can includes keywords  (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) which will be substituted automatically, and also html tags like <b>...</b> or <i></i> ';
$string['mod_form_field_welcome_default'] = '<br>Welcome to <b>%%CONFNAME%%</b>!<br><br>For help on using Whoteach Live see these (short)  <a href="event:http://www.Whoteach Live.org/content/videos"><u>tutorial videos</u></a>.<br><br>To join the audio bridge click the phone icon (top center). <b>Please use a headset to avoid causing background noise for others.</b>';
...
$string['mod_form_field_instanceprofiles_help'] = 'Select the type for this Whoteach Live instance.';
...
$string['view_error_unable_join_student'] = 'Unable to connect to the Whoteach Live server. Please contact your Teacher or the Administrator.';
$string['view_error_unable_join_teacher'] = 'Unable to connect to the Whoteach Live server. Please contact the Administrator.';
$string['view_error_unable_join'] = 'Unable to join the meeting. Please check the url of the Whoteach Live server AND check to see if the Whoteach Live server is running.';
$string['view_error_bigbluebutton'] = 'Whoteach Live responded with errors. {$a}';
$string['view_error_create'] = 'The Whoteach Live server responded with an error message, the meeting could not be created.';
...
$string['view_noguests'] = 'The Whoteach Live is not open to guests';
...
$string['view_message_recordings_disabled'] = 'Recordings were disabled on this server. Whoteach Live instances for recordings only can not be used.';
...
$string['view_recording_publish_link_deleted'] = 'This link can not be re-published because the actual recording does not exist in the current Whoteach Live server. The link should be removed.';
...
$string['view_recording_unprotect_link_deleted'] = 'This link can not be un-protected because the actual recording does not exist in the current Whoteach Live server. The link should be removed.';
...
$string['view_error_current_state_not_found'] = 'Current state was not found. The recording may have been deleted or the Whoteach Live server is not compatible with the action performed.';
$string['view_error_action_not_completed'] = 'Action could not be completed';
$string['view_warning_default_server'] = 'This Moodle server is making use of the Whoteach Live testing server that comes pre-configured by default. It should be replaced for production.';
...
$string['index_error_noinstances'] = 'There are no instances of Whoteach Live';
$string['index_error_bbtn'] = 'Whoteach Live ID {$a} is incorrect';
