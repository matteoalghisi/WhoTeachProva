...
/**
 * Strings for component 'bigbluebuttonbn', language 'it', branch 'MOODLE_39_STABLE'
 *
...
$string['config_recording_all_from_start_default'] = 'Registra dall\'inizio';
$string['config_recording_all_from_start_default_description'] = 'Il meeting sarà registrato dall\'inizio';
...
$string['config_server_url'] = 'URL del server Whoteach Live';
$string['config_server_url_description'] = 'L\'URL del server Whoteach Live deve terminare con /Whoteach Live/. (L\'URL di default è un server Whoteach Live messo a disposizione da Blindside Networks a scopi di test).';
$string['config_shared_secret'] = 'Shared Secret Whoteach Live';
$string['config_shared_secret_description'] = 'Il salt di sicurezza del server Whoteach Live. (Il salti di default è per un server Whoteach Live messo a disposizione da Blindside Networks a scopi di test).';
...
$string['ends_at'] = 'Fine';
$string['event_activity_created'] = 'Creata attività Whoteach Live';
$string['event_activity_deleted'] = 'Eliminata attività Whoteach Live';
$string['event_activity_updated'] = 'Aggiornata attività Whoteach Live';
$string['event_activity_viewed'] = 'Visualizzata attività Whoteach Live';
$string['event_meeting_created'] = 'Creato meeting Whoteach Live';
$string['event_meeting_ended'] = 'Terminato forzatamente meeting Whoteach Live';
$string['event_meeting_joined'] = 'Acceduto meeting Whoteach Live';
$string['event_meeting_left'] = 'Lasciato meeting Whoteach Live';
...
$string['general_error_unable_connect'] = 'Non è possibile stabilire il collegamento. Verificare l\'URL del server Whoteach Live e controllare che il server Whoteach Live sia in linea.';
...
$string['index_heading'] = 'Stanze Whoteach Live';
...
$string['pluginadministration'] = 'Gestione Whoteach Live';
...
$string['view_noguests'] = 'Whoteach Live non è accessibile dagli ospiti';
