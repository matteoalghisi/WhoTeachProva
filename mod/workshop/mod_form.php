...
class mod_workshop_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        // Introduction
		include('../metadata/mod/mod_form_workshop.php');	// _s_t_mod_
        ...
        $mform->addGroup(array(
            ...
            $mform->createElement('select', 'gradecategory', '', $gradecategories,'style="visibility:hidden"'), //s_t_mod
        ...
        $mform->addGroup(array(
            ...
            $mform->createElement('select', 'gradinggradecategory', '', $gradecategories,'style="visibility:hidden"'), //s_t_mod
