...
$oldchapters = $DB->get_records('recommend_chapters', array('recommendid'=>$recommend->id), 'pagenum', 'id, pagenum, subchapter');
...
if (!$nothing) {
    ...
    foreach ($newchapters as $ch) {
        ...
        $ch = $DB->get_record('recommend_chapters', array('id' => $ch->id));
