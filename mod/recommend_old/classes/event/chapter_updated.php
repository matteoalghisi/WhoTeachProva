...
/**
 * The mod_recommend chapter updated event.
 *
...
/**
 * The mod_recommend chapter updated event class.
 *
 * @package    mod_recommend
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class chapter_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the chapter with id '$this->objectid' for the recommend with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'recommend', 'update chapter', 'view.php?id=' . $this->contextinstanceid . '&chapterid=' .
    ...
    public static function get_name() {
        return get_string('eventchapterupdated', 'mod_recommend');
    }
