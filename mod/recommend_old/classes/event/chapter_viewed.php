...
/**
 * The mod_recommend chapter viewed event.
 *
...
/**
 * The mod_recommend chapter viewed event class.
 *
 * @package    mod_recommend
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class chapter_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the chapter with id '$this->objectid' for the recommend with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'recommend', 'view chapter', 'view.php?id=' . $this->contextinstanceid .
    ...
    public static function get_name() {
        return get_string('eventchapterviewed', 'mod_recommend');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/recommend/view.php', array('id' => $this->contextinstanceid, 'chapterid' => $this->objectid));
    }
