@mod @mod_recommend
Feature: In a recommend, change the navigation options
  In order to change the way a recommend's chapters can be traversed
  As a teacher
  I need to change navigation options on a recommend
  ...
  Scenario: Change navigation options
    Given I add a "recommend" to section "1" and I fill the form with:
      | Name | Test recommend |
      | Description | A recommend about lorem ipsum |
    ...
    And I should see "Test recommend"
