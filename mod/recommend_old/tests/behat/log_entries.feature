@mod @mod_recommend
Feature: In a recommend, verify log entries
  In order to create log entries
  As an admin
  I need to perform various actions in a recommend.

  @javascript @_switch_window
  Scenario: perform various recommend actions and verify log entries.
    Given the following "courses" exist:
      | fullname | shortname | category | groupmode |
      | Course 1 | C1 | 0 | 1 |
    And I log in as "admin"
    And I am on "Course 1" course homepage with editing mode on
    When I add a "recommend" to section "1" and I fill the form with:
      | Name | Test recommend |
    ...
    And I navigate to "Print recommend" in current page administration
    And I navigate to "Generate IMS CP" in current page administration
    And I navigate to "Logs" in current page administration
    Then I should see "recommend exported"
    And I should see "recommend printed"
    ...
    And I should see "1. First chapter edited" in the ".recommend_content" "css_element"
    And I switch to the main window
    And I click on "Chapter viewed" "link" in the "#report_log_r3_c5" "css_element"
    And I switch to "action" window
    And I should see "2. Second chapter" in the ".recommend_content" "css_element"
    And I switch to the main window
