@mod @mod_recommend
Feature: In a recommend, create chapters and sub chapters
  In order to create chapters and subchapters
  As a teacher
  I need to add chapters and subchapters to a recommend.
  ...
  Scenario: Create chapters and sub chapters and navigate between them
    ...
    And I should see "1. Dummy first chapter" in the ".recommend_content" "css_element"
    And I should see "1.1. Dummy first subchapter" in the ".recommend_content" "css_element"
    And I click on "Next" "link"
    And I should see "2. Dummy second chapter" in the ".recommend_content" "css_element"
    And I should see "2. Dummy second chapter" in the "strong" "css_element"
    And I should not see "Next" in the ".recommend_content" "css_element"
    And I click on "Exit recommend" "link"
    And I should see "Test recommend" in the "Topic 1" "section"
    And I follow "Test recommend"
    And I should not see "Previous" in the ".recommend_content" "css_element"
    And I should see "1. Dummy first chapter" in the "strong" "css_element"
    When I click on "Next" "link"
    Then I should see "1.1. Dummy first subchapter" in the ".recommend_content" "css_element"
