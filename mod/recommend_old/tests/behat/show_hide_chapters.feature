@mod @mod_recommend
Feature: recommend activity chapter visibility management
  In order to properly manage chapters in a recommend activity
  As a teacher
  ...
  Scenario: Show/hide chapters and subchapters
    ...
    And I follow "Next"
    And I should see "Second chapter" in the ".recommend_content" "css_element"
    And I should not see "Exit recommend"
    And I follow "Next"
    And I should see "Sub chapter" in the ".recommend_content" "css_element"
    And I follow "Next"
    And I should see "Third chapter" in the ".recommend_content" "css_element"
    And I follow "Next"
    And I should see "Fourth chapter" in the ".recommend_content" "css_element"
    And I follow "Exit recommend"
    And I log out
    ...
    And I follow "Exit recommend"
    And I follow "Test recommend"
    And I should see "First chapter" in the ".recommend_content" "css_element"
