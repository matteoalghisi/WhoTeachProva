...
<html>
	...
	<body>
		...
		<div class="progress" style = "margin: 0 0 3% 10%; width:80%;">
		...
		<center>
			...
			<div style = "text-align:left; margin-left:10%; margin-right:10%">
				...
				<h5 style = "margin-bottom:4%;">  <?php echo convert_RS('COURSE NAME') . ': '; ?> <i style = "float:right;"><?php echo $_SESSION['course']['name'];?></i> </h5>
				
				<h5 style = "margin-bottom:4%;"> <?php echo convert_RS('KNOWLEDGE AREA') . ': '; ?> <i style = "float:right;"><?php echo $_SESSION['course']['ka'];?></i> </h5>
				
				<h5 style = "margin-bottom:8%;"> <?php echo convert_RS('PARTS') . ': '; ?> <i style = "float:right;"> <?php echo $_SESSION["data"]["nop"]; ?></i> </h5> 
				
				<h4 style = "margin-bottom:2%;"> <?php echo convert_RS('Selezione delle risorse'); ?> </h5> 
				...
				<?php
					for($i = 1; $i <= count($_SESSION['course']['parts']); $i++)
					{
						...
						if ($i == $corrente)
							print '<font color="red"><h5> Nome Sezione'.$i.':  <i style = "float:right;">' .convert_RS($_SESSION['course']['parts'][$i]['name']).'</i></h5></font>';
						else
						{
