					...
					<tr>
						...
						<td align="center">
							<div class="form-group">
								<label for="metadata_list"></label>
									<div class="controls">
										<input type="text" class="input-large" style="font-size:20px; border-radius:6px; margin-left:5px; margin-top:20px;" id="modn" name="modn" placeholder="<?php echo convert_RS('Insert module name'); ?>" value="<?php $title = $_SESSION['course']['parts'][$partecorrente]['name']; if ($title !== 'Part not inserted yet') print $title; ?>">
									</div>
							</div>
						</td>	
					</tr>
