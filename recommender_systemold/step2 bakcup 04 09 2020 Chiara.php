...
<html lang="en">
	...
	<body>
		...
		<center>
			...
			<h1 style="text-align:center; margin-left: 20%; margin-right:20%; margin-top:5%; margin-bottom:3%;">
				<font color="#383a3d">
					<!-- 
...
-->
			...
			<!-- aggiunto da Chiara: -->
			<div class = "topwords">
				<h5 style="text-align:center;  margin-left: 20%; margin-right: 20%;"><?php echo convert_RS('step2 advice') ?> </h5>
			</div>
				...
				while($i<$num_schermate)
				{
					...
					while($bool == 0 && $j<$num_rules)
					{
						...
						else
						{
							...
							//s_t_mod Chiara: modifica CSS checkbox:
							...
							echo "<p style='padding-left:40px; padding-top:8px; padding-right:10px; float:left;'><input style='margin-left:5px;' type=\"checkbox\" id=\"".$rule['IDrule']."\" value=\"" . $myModules . "\" name=\"" .$tok. "\" onchange=\"update(this);\"/></p>".$newrule."<br>";
