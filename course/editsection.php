...
if ($deletesection) {
    ...
    if (course_can_delete_section($course, $sectioninfo)) {
        ...
        if ($confirm) {
			...
			////////////////////////////////////////////////////////////////
			/// PARTE DI ELIMINAZIONE DEI METADATI REALTIVI ALLA SEZIONE ///
			////////////////////////////////////////////////////////////////
			include "../metadata/delete_metadata/section_delete.php"; // _s_t_mod_ 
			////////////
			/// FINE ///
			////////////
...
if ($mform->is_cancelled()){
	...
	include "../metadata/course/editsection.php"; // _s_t_mod_
