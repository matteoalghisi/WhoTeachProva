...
require_once($CFG->dirroot. '/metadata/metadata_page/aux_functions.php'); //funzioni RS s_t_mod
...
//parte personalizzata per recommender system s_t_mod
if ((isloggedin()) && (has_capability('moodle/course:managefiles', context_system::instance())) ) {
echo '
<div class="buttons">
	<div class="singlebutton">
		<form method="POST" action="' . $CFG->wwwroot . '/recommender_system/index.php">
			<input type="submit" class="btn btn-secondary" value="'.convert_RS("Add a course through Recommender System").'">
