...
function course_add_cm_to_section($courseorid, $cmid, $sectionnum, $beforemod = null) {
	...
	//include ($CFG->wwwroot."/metadata/course/lib.php"); // _s_t_mod_
	include ("../metadata/course/lib.php"); // _s_t_mod_
...
function delete_mod_from_section($modid, $sectionid, $delmetadata=TRUE) {// _s_t_mod_ 
    global $DB;
    ...
    if ($section = $DB->get_record("course_sections", array("id"=>$sectionid)) ) {
        ...
        if ($key = array_keys ($modarray, $modid)) {
			...
			////////////////////////////////////////////////////////////
			/// PARTE DI ELIMINAZIONE DEI METADATI REALTIVI ALLA RISORSA ///
			////////////////////////////////////////////////////////////
			if($delmetadata)
				include "../metadata/delete_metadata/resource_delete.php"; // _s_t_mod_ 
			////////////
			/// FINE ///
			////////////
...
function moveto_module($mod, $section, $beforemod=NULL) {
    ...
    if (! delete_mod_from_section($mod->id, $mod->section, FALSE)) {  //_s_t_mod  //non voglio cancellare i metadati quadno sposto una risorsa, quindi aggiungo FALSE
