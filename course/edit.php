...
if ($id) {
	...
	//$category = $DB->get_record('course_categories', array('id'=>$course->category), '*', MUST_EXIST); // moodle original
	
	if($categoryid) //s_t_mod Hui
		$category = $DB->get_record('course_categories', array('id'=>$categoryid), '*', MUST_EXIST); //s_t_mod Hui
	else //s_t_mod Hui
		$category = $DB->get_record('course_categories', array('id'=>$course->category), '*', MUST_EXIST); //s_t_mod Hui
...
if ($editform->is_cancelled()) {
    ...
    if (empty($course->id)) {
		...
		// _s_t_mod_
		include "../metadata/course/edit_part1.php";
		...
		// _s_t_mod_
		include "../metadata/course/edit_part2.php";
