...
$string['pluginname'] = "test blockz";
$string['testblockz:addinstance'] = 'Add a new test blockz';
$string['testblockz:myaddinstance'] = 'Add a new test blockz to MY HOME page';

$string['viewreports'] = "Vista report";
$string['addreports'] = "Aggiungi gruppo";
$string['delreports'] = "Elimina gruppo";



$string['blockname'] = " Reports";
