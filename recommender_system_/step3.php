	...
	<body style="background-color:#F0F0F0" onload="getRecommendations()">
		...
		<div class="container-fluid">
			...
			<div class="modal-dialog" id="modalRisorsa">
						...
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            ...
                            <div class="row" id="rowAnteprimaRisorse" name="rowFullDesktop">
								...
								<div class="col" id="colAnteprimaDescription">
									...
									<div class="row justify-content-center" style="margin-top:1vh;display:flex;justify-content:center;text-align:center;height:21vh;overflow-y:auto;" id="scrollDescription">
				...
				<!-- RIGA CONTENENTE LA FINESTRA DI ERRORE -->
				<div class="row" id="rowContenitorePrincipale" name="downloadError" style="margin-top:5vh;display:none;">
					...
					<div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12 col-xs-12" id="contenitorePrincipale">
						...
						<div class="row" id="rowTitleFinestra">
							<div class="col-12">
								<p class="titleFinestra">ERRORE</p>
							</div>
						</div>
