...
if (!has_capability('moodle/course:managefiles', context_system::instance()))
	...
	switch ($category) 
	{
		...
		case 'Visione imprenditoriale':
			...
			break;
		case 'SIAM':
			if($categoriaCorso=="Abilità informatiche"){
				$categoryId = 21;
			}else{
				$categoryId = 31;
			}
		...
		case 'UNIMIB':
			$categoryId = 38;
			break;
		case 'DEMO CLIENTI/ENTI':
			if($categoriaCorso=="Abilità informatiche"){
				$categoryId = 37;
			}else if($categoriaCorso=="Visione imprenditoriale"){
				$categoryId = 35;
			}else{
				$categoryId = 32;
			}
		...
		case 'Noovle demo':
			$categoryId = 40;
			break;
		case 'Corsi Social Things':
			$categoryId = 41;
			break;
		case 'Sportello Amico':
			$categoryId = 42;
			break;
		case 'INFORMATTIVA SRL':
			$categoryId = 27;
			break;
		case 'SELECT':
			$categoryId = 39;
