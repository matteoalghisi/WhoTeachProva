		...
		<div class="container-fluid">
			...
			<form method="POST" action="step1.php" name="myForm" id="myForm" onsubmit="return check()">
				...
				<div class="modal-dialog modal-sm">
					...
					<div class="modal-body" style="height:20vh;overflow-y:auto;" id="sectionsContent">
							...
							<div class="col-6" id="colAttribute" style="display:flex;justify-content:center;">
								<select class="form-select" aria-label="Default select example" id="selectCategoria" name="categoryCourse" onchange="showSubcategory(this.value)">
									...
									<?php
										...
										$result = mysqli_query($connection, "SELECT DISTINCT name,id FROM mdl_course_categories ORDER BY name ASC" );

										while($row=mysqli_fetch_row($result)){

											if($row[1]=='1' || $row[1]=='14' || $row[1]=='15' || $row[1]=='16' || $row[1]=='20'){
						...
						<div class="row justify-content-center" id="rowAttribute">
							...
							<div class="col-6" id="colAttribute" style="display:flex;justify-content:center;">
								<select class="form-select" aria-label="Default select example" id="selectSottocategoria" name="subcategoryCourse" disabled>
									...
									<option value="ADHR" name="ADHR" style="display:none">ADHR</option>
									<option value="ALTEREGO SRL" name="ALTEREGOSRL" style="display:none">ALTEREGO SRL</option>
									<option value="ITS RIZZOLI" name="ITSRIZZOLI" style="display:none">ITS RIZZOLI</option>
									<option value="SIAM" name="SIAM" style="display:none">SIAM</option>
									<option value="UNIMI" name="UNIMI" style="display:none">UNIMI</option>
									<option value="UNIMIB" name="UNIMIB" style="display:none">UNIMIB</option>
									<option value="DEMO CLIENTI/ENTI" name="DEMOCLIENTI/ENTI" style="display:none">DEMO CLIENTI/ENTI</option>
									<option value="Noovle demo" name="Noovledemo" style="display:none">Noovle demo</option>
									<option value="Corsi Social Things" name="CorsiSocialThings" style="display:none">Corsi Social Things</option>
									<option value="Sportello Amico" name="SportelloAmico" style="display:none">Sportello Amico</option>
									<option value="INFORMATTIVA SRL" name="INFORMATTIVASRL" style="display:none">INFORMATTIVA SRL</option>
									<option value="SELECT" name="SELECT" style="display:none">SELECT</option>
				...
				<div class="row justify-content-center" id="rowArrowMobile" style="margin-top:5vh;">
						<div class="col-auto">
							<button type="button" class="btn btn-warning" id="arrowMobile"  onclick="showSectionsModal()">Vai avanti ></button>
						</div>
				</div>
